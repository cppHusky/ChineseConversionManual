...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \end{spacing}
    \end{itemize}
	\item \content{使用字體\footnote{本書所用字體多為免費商用授權之字體，亦有少部分字體僅供非營利或學術研究之用途。部分字體來源於\href{https://github.com/wordshub/free-font}{此GitHub倉庫}。}}{使用字体\footnote{本书所用字体多为免费商用授权之字体，亦有少部分字体仅供非营利或学术研究之用途。部分字体来源于\href{https://github.com/wordshub/free-font}{此GitHub仓库}。}}
	\begin{itemize}
		...
		\item \begin{spacing}{.5}
			\content{其它}{其它}\vspace{2pt}\\
			\footnotesize
			\content{王漢宗勘亭流繁}{王汉宗勘亭流繁}
			、\content{全字庫正宋體}{全字库正宋体}
			、\content{王漢宗中仿宋繁}{正汉宗中仿宋繁}
			、\content{方正書宋}{方正书宋}
