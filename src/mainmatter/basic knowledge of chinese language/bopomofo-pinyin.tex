...
\content{但是讀者也要當心聰明反被聰明誤。就拿拼音\boxpinyin{q}來說，實際上英文中的q常發類似於\boxzhupin{ㄎ}{k}的音（如unique, Iraq等詞）。那麼我們就有可能受此誤導，把\boxpinyin{q}對應到\boxzhuyin{ㄎ}上去了。但它其實應該是\boxzhuyin{ㄑ}才對。}{但是读者也要当心聪明反被聪明误。就拿拼音\boxpinyin{q}来说，实际上英文中的q常发类似于\boxzhupin{ㄎ}{k}的音（如unique, Iraq等词）。那么我们就有可能受此误导，把\boxpinyin{q}对应到\boxzhuyin{ㄎ}上示了。但它其实应该是\boxzhuyin{ㄑ}才对。}\par
...
\begin{table}[H]
    ...
    \end{NiceTabular}
\end{table}
\content{最後是聲調的問題。漢語拼音中的聲調習慣與注音和威妥瑪拼音都不同，不是把音調記號放在字母的右上方，而是放在某一個字母的正上方，像\boxzhupin{ㄔㄨㄤ}{\pinyin{chuang1}}這樣。而值得探究的問題是，聲調符號到底要標在哪個字母的上方呢？我們稍後再來談。}{最后是声调的问题。汉语拼音中的声调习惯与注音和威妥玛拼音都不同，不是把音调记号放在字母的右上方，而是放在某一个字母的正上方，像\boxzhupin{ㄔㄨㄤ}{\pinyin{chuang1}}这样。而值得探究的问题是，声调符号到底要标在哪个字母的上方呢？我们稍后再来谈。}\par
