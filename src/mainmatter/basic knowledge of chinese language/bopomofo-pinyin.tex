...
\content{注音中的介母，也稱作「韻頭」。顧名思義，它是韻母的「開頭」。以「強」字為例，它的一個讀音是\boxzhupin{ㄑㄧㄤˊ}{\pinyin{qiang2}}。在拼讀過程中，我們可以把它拆作三部分：聲母\boxzhupin{ㄑ}{q}、介母\boxzhupin{ㄧ}{i}和韻母\boxzhupin{ㄤ}{ang}（聲調為二聲）。其中\boxzhupin{ㄧ}{i}的作用十分清晰。}{注音中的介母，也称作“韵头”。顾名思义，它是韵母的“开头”。以“强”字为例，它的一个读音是\boxzhupin{ㄑㄧㄤˊ}{\pinyin{qiang2}}。在拼读过程中，我们可以把它拆作三部分：声母\boxzhupin{ㄑ}{q}、介母\boxzhupin{ㄧ}{i}和韵母\boxzhupin{ㄤ}{ang}（声调为二声）。其中\boxzhupin{ㄧ}{i}的作用十分清晰。}\par
\content{介母最有趣的地方在於，當遇到零聲母\footnote{有些音沒有聲母，比如「安」字唸作\boxzhupin{ㄢ}{an}，這就是零聲母。}的情況時，作為「韻頭」的介母可以「退化」成聲母，與「韻身」組合成一個音。簡單說，\textbf{這時候「介母」的作用是聲母！}}{介母最有趣的地方在于，当遇到零声母\footnote{有些音没有声母，比如“安”字念作\boxzhupin{ㄢ}{an}，这就是零声母。}的情况时，作为“韵头”的介母可以“退化”成声母，与“韵身”组合成一个音。简单说，\textbf{这时候“介母”的作用是声母！}}\par
...
\begin{table}[H]
    ...
    \begin{NiceTabular}{>{\columncolor{blue!7.5}}c*{2}{>{\columncolor{red!7.5}}c}}[hlines]
        ...
        \boxzhuyin{ㄧ} & \boxpinyin{i} & \boxpinyin{y} \\
        \boxzhuyin{ㄨ} & \boxpinyin{u} & \boxpinyin{w} \\
        \boxzhuyin{ㄩ} & \boxpinyin{\"u} & \\\bottomrule
    \end{NiceTabular}
\end{table}
...
\content{在學習拼音時，我們一定接觸過一些「整體認讀」的音。以「\xpinyin*{知}」為例，如果要強行把聲母\boxpinyin{zh}和韻母\boxpinyin{i}拼出來，我們是拼不出「知」字的。但是，如果\textbf{只用聲母\boxpinyin{zh}來拼讀，我們卻是可以「拼」出此字的。}}{在学习拼音时，我们一定接触过一些“整体认读”的音。以“\xpinyin*{知}”为例，如果要强行把声母\boxpinyin{zh}和韵母\boxpinyin{i}拼出来，我们是拼不出“知”字的。但是，如果\textbf{只用声母\boxpinyin{zh}来拼读，我们却是可以“拼”出此字的。}}\par
...
\content{我們很容易看出，拼音\boxpinyin{uai}是由介母（韻頭）\boxpinyin{u}與韻身\boxpinyin{ai}結合而成的。我們也不難理解，\boxpinyin{uai}和\boxpinyin{ai}兩個音是押韻的，它們都押在\boxpinyin{ai}音上。}{我们很容易看出，拼音\boxpinyin{uai}是由介母（韵头）\boxpinyin{u}与韵身\boxpinyin{ai}结合而成的。我们也不难理解，\boxpinyin{uai}和\boxpinyin{ai}两个音是押韵的，它们都押在\boxpinyin{ai}音上。}\par
\content{但是，如果我說，\boxpinyin{ei}和\boxpinyin{ui}是押韻的，它們都押在\boxpinyin{ei}音上，讀者是否會有些遲疑呢？}{但是，如果我说，\boxpinyin{ei}和\boxpinyin{ui}是押韵的，它们都押在\boxpinyin{ei}音上，读者是否会有些迟疑呢？}\par
\content{其實，\boxpinyin{ui}的完整形式應當是\boxpinyin{uei}；只是拼音為了書寫方便之故，將其作了簡化。如果還原成\boxpinyin{uei}，那麼我們就很容易理解它的韻腳，也很容易推導出它的注音——\boxpinyin{u}對應\boxzhuyin{ㄨ}，\boxpinyin{ei}對應\boxzhuyin{ㄟ}，所以\boxpinyin{ui}就是\boxzhuyin{ㄨㄟ}啦。}{其实，\boxpinyin{ui}的完整形式应当是\boxpinyin{uei}；只是拼音为了书写方便之故，将其作了简化。如果还原成\boxpinyin{uei}，那么我们就很容易理解它的韵脚，也很容易推导出它的注音——\boxpinyin{u}对应\boxzhuyin{ㄨ}，\boxpinyin{ei}对应\boxzhuyin{ㄟ}，所以\boxpinyin{ui}就是\boxzhuyin{ㄨㄟ}啦。}\par
\content{類似的原理在\boxzhupin{ㄡ}{ou}\boxzhupin{ㄣ}{en}\boxzhupin{ㄥ}{eng}中也是如此。只要我們「還原」了拼音的完整形 式，由拼音推導注音只需做一對一轉換就足矣！（\cref*{table:需要推導的韻母}）}{类似的原理在\boxzhupin{ㄡ}{ou}\boxzhupin{ㄣ}{en}\boxzhupin{ㄥ}{eng}中也是如此。只要我们“还原”了拼音的完整形式，由拼音推导注音只需做一对一转换就足矣！(\cref*{table:需要推導的韻母})}\par
\begin{table}[H]
    \centering
    \caption{需要推導的韻母}
    \label{table:需要推導的韻母}
...
\begin{table}[H]
    ...
    \end{NiceTabular}
\end{table}
\content{當介母\boxpinyin{u}作聲母時，它將變成\boxpinyin{w}。所以\boxpinyin{wei}其實是零聲母的\boxpinyin{uei}。因此，「威」字的注音是\boxzhuyin{ㄨㄟ}，它和有聲母的「規\boxzhuyin{ㄍㄨㄟ}」是相同韻母的。}{当介母\boxpinyin{u}作声母时，它将变成\boxpinyin{w}。所以\boxpinyin{wei}其实是零声母的\boxpinyin{uei}。因此，“威”字的注音是\boxzhuyin{ㄨㄟ}，它和有声母的“规\boxzhuyin{ㄍㄨㄟ}”是相同韵母的。}\par
\content{當介母\boxpinyin{\"u}\footnote{提醒讀者，當\boxpinyin{\"u}以\boxpinyin{j q x y}為前綴時，\boxpinyin{\"u}的寫法將簡化為\boxpinyin{u}。所以拼音中出現的\boxpinyin{u}究竟是\boxpinyin{u}還是\boxpinyin{\"u}，需要讀者自行甄別。}作聲母時，情況有些不同。在拼音中，我們對它的處理方式是為它加上一個偽聲母\boxpinyin{y}\footnote{這或許是因為，撮口呼的口型本身就包含了齊齒呼的口型，所以\boxpinyin{y}音將被\boxpinyin{\"u}覆蓋，不起作用。}。所以\boxpinyin{yuan}其實是\boxpinyin{\"uan}，那麼「元」的注音為\boxzhuyin{ㄩㄢˊ}就不難理解了！}{当介母\boxpinyin{\"u}\footnote{提醒读者，当\boxpinyin{\"u}以\boxpinyin{j q x y}为前缀时，\boxpinyin{\"u}的写法将简化为\boxpinyin{u}。所以拼音中出现的\boxpinyin{u}究竟是\boxpinyin{u}还是\boxpinyin{\"u}，需要读者自行甄别。}作声母时，情况有些不同。在拼音中，我们对它的处理方式是为它加上一个伪声母\boxpinyin{y}\footnote{这或许是因为，撮口呼的口型本身就包含了齐齿呼的口型，所以\boxpinyin{y}音将被\boxpinyin{\"u}覆盖，不起作用。}。}\par
...
\content{在通韻中，拼音的\boxpinyin{eng}和\boxpinyin{ong}是兩個韻，不能通押。從發音本身來看，\boxzhuyin{ㄨ}和\boxzhuyin{ㄥ}拼起來的\boxpinyin{ueng}也與\boxpinyin{ong}音有明顯差異。但是，注音系統並沒有區分這兩個音，只是規定它們在不同場合下讀法不同：零聲母時讀成\boxpinyin{weng}，有聲母時讀成\boxpinyin{ong}。}{在通韵中，拼间的\boxpinyin{eng}和\boxpinyin{ong}是两个韵，不能通押。从发音本身来看，\boxzhuyin{ㄨ}和\boxzhuyin{ㄥ}拼起来的\boxpinyin{ueng}也与\boxpinyin{ong}音有明显差异。但是，注音系统并没有区分这两个音，只是规定它们在不同场合下读法不同：零声母时读成\boxpinyin{weng}，有声母时读成\boxpinyin{ong}。}\par
